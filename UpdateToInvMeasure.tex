...
We note that in order to prove \eqref{E:RhoDom}, it suffices to show that there exists some $K'_a \in \mathbb{N}$ such that
	...
	\textcolor{blue}{The following is incorrect because $\rho$ does not need to be bounded. Continuity and integrability do not imply boundedness on the whole space.}
