...
\end{equation}
Several examples of admissible weights are (see Example in Section 2 of \cite{TessitoreZabczyk98M})
\begin{equation}
	\label{E:admRho}
	\begin{aligned}
...
\begin{remark}
	...
	(up to a constant). However, one can easily check that the admissible condition in \eqref{E:aw}
	exclude these two cases. It may be much less obvious that the following function
	\begin{equation*}
