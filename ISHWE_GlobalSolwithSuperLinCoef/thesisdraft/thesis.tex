...
Here is the main result of this chapter.
	...
	Suppose that $\sigma$ satisfies \eqref{C:SigSupLin} and the initial data are such that for each $\widehat{C}_T < \infty$ for and $T>0$. Then for any $R>0$ and $(t,x) \in [0,T] \times B_R(0)$, there exists a random field solution to \eqref{E:SupLinSPDE} denoted as $(u(t,x): (t,x) \in [0,T] \times B_R(0))$. This solution is unique and satisfies 
	\begin{equation}
...
%		\end{enumerate}}
	...
	\subsection{Proof of Theorem \ref{T:MainSupLin}}
