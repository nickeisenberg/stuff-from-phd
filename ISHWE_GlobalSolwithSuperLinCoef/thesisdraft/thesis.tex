...
The reason that this is an issue is that in order to following the proof of \cite[Proposition 4.10]{millet.sanz-sole:21:global}, we would need that for $i \in \{1,2\}$,
	...
	\]
which is the case when $\alpha = \beta = 2$. Also, if you look at the corresponding \cite[Equation (4.63)]{millet.sanz-sole:21:global}, you will see that the $|y_i|$ term is not there. This is because the wave fundamental solution has compact support. A brief comment about thus is made in the proof of \cite[Theorem 4.1]{hu.huang.ea:14:on}. Lastly, note that in order to apply \cite[Equations (4.62) and (4.63)]{millet.sanz-sole:21:global} then we will need to prove a corresponding \cite[Proposition 4.9]{millet.sanz-sole:21:global}. This proposition should be able to be verified under the assumption that $u_0=1$ and $v_0=0$ because in this case, the solution of the space-time fractional equation satisfies 
	\[
		u(t,x) = 1 - I(t,x).
	\]
