...
\begin{enumerate}
  ...
  \item p. 2, the equation for $\sigma_N(x)$, the word "continuous and" is confusing. Should we just say that
    ...
    Response - I do not believe it is possible to write $\sigma_N$ explicitly in higher dimensions. It may be more clear to just give $\sigma_N$ is one dimension and then mention that it is defined similarly in higher dimensions as this is what is done in Millet and Sanz-Sol\'e's paper.  
  ...
  \item Regarding Proposition 2.4:
     \begin{enumerate}
       ...
       \item You may remove [MS21, Proposition 3.2] since you are going to prove this one. But you may mention the
         ...
         Response - I will remove these at the very end. I want to keep it for now as it allows me to quickly go back and compare the results. 
       ...
       \item It is cumbersome to put the two cases formula in other equations. Let's define the right-hand side of
         ...
         Response - I just realized that I have already defined that quantity as $\mathcal{T}_0$ in the statement of the proposition. I will use $\mathcal{T}_0$ to replace the 'cases' throughout the proof.
     \end{enumerate}
