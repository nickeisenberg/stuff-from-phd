...
&\le C|\xi|^{2r} \left(\int_{\R^d} \mu(\ud \zeta) \frac{|\zeta|^{2r}}{\left(1+ |\zeta|^{\alpha}\right)^{2}} \right) \left[c(\sigma) + L(\sigma)\sup_{(s,y) \in [0,T] \times \R^d} \Norm{u(s,y)}_{p}\right]^2 \int_0^t \ud s \:   (t-s)^{2(\beta + \gamma -1) - \frac{\beta \lambda}{\alpha} - \frac{2r\beta}{\alpha}}\\
& \qquad  + C \left(\int_{\R^{d}}  \frac{ \mu(\ud \zeta) }{\left(1+ |\zeta|^\alpha\right)^2 } \right)L^2(\sigma) t^{2(\beta + \gamma -1)-\beta \lambda / \alpha}\int_0^t \ud s \:  \sup_{|z_1-z_2| = |\xi| }\Norm{u(s,z_1) - u(s, z_2)}_p^2,
\end{align*}
