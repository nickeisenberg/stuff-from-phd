...
\begin{tikzpicture}[scale=1, transform shape, x = 4em, y = 4em]
  ...
  \filldraw[draw = white, pattern color = black!35, pattern=fivepointed stars] (1,4) -- (1,2) -- (4,2) -- (4,4) -- cycle;
  \filldraw[draw = white, pattern color = black!35, pattern=north east lines] (2.5,4) -- (2.5,0.5) -- (4,0.5) -- (4,4) -- cycle;
  \filldraw[draw = white, pattern color = black!35, pattern = dots] (1.01,0.01) -- (1.01,4) -- (4,4) -- (4,0.01) -- cycle;
  \filldraw[draw = white, opacity = 0.3, fill color = black!35] (2.51,0.02) -- (2.51,4) -- (4,4) -- (4,0.02) -- cycle;
  ...
  \draw (3,0.1) --++(0,-0.2) node[below right, yshift = 5pt] {$d$};
  ...
  \node[] (Upsilonalpha0infty) at (3.30,0.75) {$\Upsilon_\alpha(0)<\infty$};
  \node[] (Upsilonalpha0infty) at (1.75,0.25) {$\Upsilon(\beta)<\infty$};
  \node[] (Upsilonalpha0infty) at (3.30,0.25) {$\Upsilon_\alpha(\beta)<\infty$};

  \draw[decorate, thick, decoration = {brace, amplitude=3pt, raise=7pt}] (0,0) -- (0,0.5) node[midway, xshift = -2.0em, rotate = 90] {$2(1-\alpha)$};
...
\begin{tikzpicture}[scale=1, transform shape, x = 4em, y = 4em]
  ...
  \filldraw[fill = black!80!white, fill opacity=0.5, draw = white] (1.01,2) -- (1.01,0.01) -- (2.5,0.01) -- (2.5,2) -- cycle; \node[draw, circle] (a) at (1.75,0.5)  {V}; % \node [above of = a] {$(<,=,=)$};
  \filldraw[fill = black!90!white, fill opacity=0.5, draw = white] (2.51,0.5) -- (2.51,0.01) -- (4,0.01) -- (4,0.5) -- cycle; \node[draw, circle] (a) at (3.35,0.25) {IV}; % \node [above of = a] {$(<,=,=)$};
