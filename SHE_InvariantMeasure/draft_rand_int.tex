...
\begin{proof}
  ...
  \end{align*}
  Then by a scaling argument,
  \begin{align*}
    I(t,x) \le C \int_0^\infty e^{-\frac{r^2}{2} + t^{b/2} r^b} r^{b-1}\ud r
           \le C \int_0^\infty e^{-\frac{r^2}{2} + T^{b/2} r^b} r^{b-1}\ud r
           < \infty.
  \end{align*}
  ...
  \begin{align*}
    | y | ^b =  \left(y_1^2+y_2^2+\cdots+y_d^2\right)^{d /2}
            \le |y_1|^b + \left(y_2^2+\cdots+y_d^2\right)^{d/2}
            = |y_1|^b + |y_*|^b.
  \end{align*}
  Hence,
  \begin{align*}
