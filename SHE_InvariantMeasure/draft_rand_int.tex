...
In the setting of equation \eqref{E:SHE}, Tessitore and Zabczyk \cite{tessitore.zabczyk:98:invariant} verified \eqref{E:BddMnt} when $\mu(\ud x) = \ud x$ under the assumption that the spectral density $\hat{f}$ satisfies \textcolor{blue}{...reference example below...}. We will expand this result and show the existence of an invariant measure when $\mu(\cdot)$ satisfies \eqref{E:InitData} and \eqref{E:GH-int} below, as well as one of the following:
\begin{enumerate}
