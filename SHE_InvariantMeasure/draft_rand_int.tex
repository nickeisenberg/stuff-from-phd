...
\begin{lemma}[Factorization lemma] \label{L:Factorize}
  Fix an arbitrary $ t_0>0$. Let $u(t, x;\mu)$ be the solution to \eqref{E:SHE} and $Y_v$ be as in
  \eqref{E:Y}. If \eqref{E:H} holds for some $\alpha\in (0,1/2)$, then the following factorization
  holds
  \begin{equation*}
