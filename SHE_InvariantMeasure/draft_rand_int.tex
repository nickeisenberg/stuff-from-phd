...
\begin{proof}
  ...
  $\mathcal{G}_\rho(t;\mu)$. Using super-additivity when $\alpha\ge 2$ and the concavity when
  ...
  \begin{align*}
    ...
    \xi \ge C.
  \end{align*}
  \textcolor{magenta}{Nick, This is not what we need. We need $t^\alpha$ term not $t^0$ tercm.}
\end{proof}
