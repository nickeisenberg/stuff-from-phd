...
(2\pi)^{d/2}\Upsilon(0)$. Comparing with the second condition in \eqref{E:U0finite}, namely,
$L_b^{-2}> 256 \Upsilon(0)$, ours are better when $d> \frac{16\log(2)}{\log(2\pi)} \approx 6.03$.
