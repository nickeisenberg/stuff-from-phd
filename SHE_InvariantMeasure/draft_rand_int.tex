...
\begin{proof}
  ...
  \end{align*}
  Now, set $g(y) = (y-r)^2 + y^b$ with $y,r>0$. By differentiation, we find that the function
  achieve its minimum at $g'(y)=0$, namely,
  \begin{align*}
    g'(y) = -2(r-y) +b y^{b-1} = 0 \quad \Longleftrightarrow \quad r = y_0+ \frac{b}{2} y_0^{b-1},
  \end{align*}
  where we use $y_0$ or $ y_0(r)$ to denote the point where the function $g$ achieve minimum. Hence,
  for all small $\epsilon\in(0,1)$,
  \begin{align*}
    I\left(1/2,x_r\right)
    \ge C\int_{y_0-\epsilon}^{y_0+\epsilon} e^{-g(y) +r^b} \ud y
    \approx C \epsilon \exp\left(-g\left(y_0(r)\right) +r^b\right).
  \end{align*}
  It reduces to show that the above exponential goes to infinity as $r\to\infty$. Notice that
  \begin{align*}
    g(y_0(r)) = (y_0(r) -r)^2 +y_0^b = \frac{b^2}{4} y_0^{2(b-1)} + y_0^{b},
  \end{align*}
  and because $b\in(1,2)$,
  \begin{align*}
    r^b = \left( y_0+ \frac{b}{2} y_0^{b-1}\right)^b\ge y_0^b + \frac{b^b}{2^b} y_0^{b(b-1)}.
  \end{align*}
  Hence,
  \begin{align*}
    r^b - g(y_0) \ge \frac{b^b}{2^b} y_0^{b(b-1)} - \frac{b^2}{4} y_0^{2(b-1)}.
  \end{align*}
