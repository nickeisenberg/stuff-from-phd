...
Following  \cite[Section 11.1]{da-prato.zabczyk:14:stochastic}, a probability measure $\eta$
on the Borel $\sigma$-field $\mathscr{B}(H)$ is said to be {\it invariant} for \eqref{E:SHE} if
...
initial condition $u(0,\cdot)=\varphi$ and $\mathscr{L}(u(t,\cdot;\varphi))(A)$ denotes the law of the solution:
	\[
		\mathscr{L}(u(t,\cdot;\varphi))(A) = \mathbb{P} \left[ \omega \in \Omega: u(t,\cdot; \varphi)(\omega) \in A \right], \quad A\in \mathscr{B}(H).
	\]
Due to the {\it Krylov-Bogoliubov theorem} (see, e.g.,
...
\begin{example} \label{Ex:Finv}
  ...
  in the fourth inequality we have applied the integration by parts. By using the {\it Fresnel
  ...
  \begin{center}
    \begin{tikzpicture}[scale=1, transform shape]
      \begin{axis}[
        ...
        legend style={at={(1.42,1)},anchor=north},
        % xmin=-8, xmax=8,
        ]
