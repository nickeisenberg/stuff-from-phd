...
and there is no added drift term, $g(x,u(t,x))$\footnote{When present, authors usually denote the drift term as $f(x,u(t,x))$, however, we have already used $f$ to denote the correlation function in this paper, so we will use $g$ for the drift.}. The challenge is proving \eqref{E:BddMnt} and it is
...
\cite{tessitore.zabczyk:98:invariant}, use the theory of the stochastic integral formulated by Da Prato and Zabcyzk \cite{da-prato.zabczyk:14:stochastic}, while in this paper we formulate and
