...
\subsection{Difficulties with Tessitore and Zabczyk's condition} \label{SS:TessZabz}
...
{\bf\noindent Situation II:~} Suppose $\widehat{f}(\cdot)$ is not strictly positive, but only nonnegative, namely, $\widehat{f}(\xi)=0$ for some $\xi\in\R^d$. Then removing the absolute value in
