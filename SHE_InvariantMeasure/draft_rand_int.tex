...
\begin{proposition}
  Let $f_s$ be the Bessel kernel defined in Example \ref{Ex:Gamma+f}. Then for $s>d-2$ and $d\ge 3$,
  it holds that
  \begin{align*}
...
\begin{proof}
  ...
  \begin{align*}
    ...
    = \frac{2\pi^{d/2}}{\Gamma\left(d/2\right)} \int_0^\infty \frac{r^{d-1}}{r^2\left(1+r^2\right)^{s/2}} \ud r.
  \end{align*}
  ...
  \end{align*}
  which is finite provided that $s>d-2>0$. This proves the proposition.
\end{proof}
