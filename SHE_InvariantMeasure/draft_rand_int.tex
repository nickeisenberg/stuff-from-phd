...
\ref{L:HUA} or do you have any concern about this lemma?}
  ...
  \begin{align*}
    \mathscr{K}_2 (\Lambda):=
    \left\{(F_\alpha h)(x): \Norm{h}_{L^q\left((0,t_0);L^2_{\tilde{\rho}}\left(\R^d\right)\right)} \le \Lambda \right\}
    \quad \text{with $\Lambda>0$}
  \end{align*}
  ...
  \begin{align*}
    ...
    & = \left\{ \big(G(t_0,\cdot)*y(\cdot)\big)(x)+(F_\alpha h)(x): \:\Norm{y}_{\tilde{\rho}}
