...
\begin{proposition}
  ...
  it holds that
  \begin{align*}
    \Upsilon(0) = \frac{2 \pi^{d/2} \Gamma\left((-d+s+2)/2\right)}{d\:(d-2)\:\Gamma\left(s/2\right)}.
  \end{align*}
\end{proposition}
\begin{proof}
  ...
  \begin{align*}
    ...
    = \frac{\pi^{d/2}}{\Gamma\left(d/2+1\right)} \int_0^\infty \frac{r^{d-1}}{r^2\left(1+r^2\right)^{s/2}} \ud r.
  \end{align*}
