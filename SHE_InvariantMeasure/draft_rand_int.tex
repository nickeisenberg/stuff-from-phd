...
\begin{proof}
  ...
  \begin{align*}
    ...
    & = C |\xi|^\alpha.
  \end{align*}
  \textcolor{magenta}{Nick, can you figure out the rest part? My strategy may not work. But I
  believe the result should be true.}
\end{proof}
...
\begin{lemma} \label{L:yineq}
  ...
  when $ t_0=0$.  Suppose that $\mu$ --- the initial condition for $u$ --- satisfies \eqref{A:icon}
  and $\widehat{f}$ satisfies Dalang's condition \eqref{E:Dalang}. Assume that for some $\alpha\in
  (0,1/2)$, condition \eqref{E:H} is satisfied. Then
  \begin{equation} \label{E:Y}
