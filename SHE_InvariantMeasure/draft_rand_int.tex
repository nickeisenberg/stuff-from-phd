...
\begin{proof}
  ...
  \begin{align*}
    ...
    & = \frac{1}{\sqrt{2\pi}}\int_{\R}G\left(1,z\right) \big| |\xi| - |x| \big|^\alpha e^{-\frac{x^2}{2}} \ud x \\
    & \ge \frac{1}{\sqrt{2\pi}}\int_{|\xi|}^\infty G\left(1,z\right) \big| |\xi| - |x| \big|^\alpha e^{-\frac{x^2}{2}} \ud x \\
  \end{align*}
...
\begin{example}[Mat\'ern correlation function]
...
\begin{proof}
  ...
  \begin{align*}
    ...
    \le I \le
    \int_0^\infty \ud z \; \exp(-z^2) z^{d-1-s/2}, \quad \text{for all $t\in[0,t]$,}
  \end{align*}
