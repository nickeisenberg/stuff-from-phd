...
\begin{proof}
  ...
  % \end{align}
  Because $b-1\in(0,1]$, by the intermediate value theorem, we see that
  \begin{align*}
    r^{b-1} - (r-y)^{b-1} = (b-1) \frac{y}{\xi^{2-b}}, \quad \text{for some $\xi\in [r-y,r]$},
  \end{align*}
  which implies that $r^{b-1} - (r-y)^{b-1} \ge (b-1) y (r-y)^{b-2}$. Hence,
  \begin{align*}
    K'(r) & \ge  e^{r^b-r^2} + b(b-1) \int_1^r e^{ - y^2 + r^b - (r-y)^b } \frac{y}{(r-y)^{2-b}} \ud y \\
          & \ge  b(b-1) \int_1^r e^{ - y^2 + r^b - (r-1)^b } \frac{1}{(r-1)^{2-b}} \ud y \\
          & \ge  b(b-1)(r-1)^{b-2} e^{r^b-(r-1)^b}\int_1^2 e^{ - y^2 } \ud y.
  \end{align*}
  ...
  \end{align*}
  \textcolor{magenta}{By setting $c= 2^{b/2 -1}>1$}. Using this, we see that
	\begin{align*}
    I(1/2, x_r) &\ge \int_{\R} e^{-y^2 +r^b - \textcolor{magenta}{\frac{b-2}{2}} |y-r|^b} \ud y \\
		 &\ge e^{r^b} \int_{|y-r|<\frac{r}{2}} e^{-y^2- \frac{b-2}{2}|y-r|^b} \\
		 &\ge e^{r^b} \int_{|y-r|<\frac{r}{2}} e^{-y^2} e^{-\frac{(b-2)r^b}{2^{b+1}}} \\
		 &= e^{(2^{b+1} -b+2)r^b / 2^b} \int_{r / 2}^{3r/2} e^{-y^2} \ud y \\
		 & \ge e^{(2^{b+1} -b+2)r^b / 2^b} e^{-9r^2 / 4}.
	\end{align*}
  ...
  and thus as $r \to \infty$,
	\begin{align*}
		\frac{(2^{b+1} -b +2)r^b}{2^b} - \frac{9r^2}{4} \to \infty.
	\end{align*}
  Putting this all together gives us that
	\begin{align*}
		I(1/2,x_r) \ge \int_{\R} e^{-y^2 +r^b - \frac{b-2}{2}|y-r|^b} \ud y \ge e^{(2^{b+1} -b+2)r^b / 2^b} e^{-9r^2 / 4},
	\end{align*}
