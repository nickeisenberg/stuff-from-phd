...
\begin{proposition}
  Let $f_s$ be the Bessel kernel defined in Example \ref{Ex:Gamma+f}. Then for $s>d-2$ and  $d\ge
  3$, it holds that
  \begin{align*}
...
\begin{proof}
  ...
  \begin{align*}
    ...
    = \frac{\pi^{d/2}}{\Gamma\left(\frac{d}{2}+1\right)} \int_0^\infty \frac{r^{d-1}}{r^2\left(1+r^2\right)^{s/2}} \ud r.
  \end{align*}
  Now by change of variable $z=\frac{r^2}{1+r^2}$, we can transform the above integral to the Beta
  integral:
  \begin{align*}
