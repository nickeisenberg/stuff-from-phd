...
to the \textit{parabolic Anderson model} \cite{carmona.molchanov:94:parabolic}.
 ...
 \textcolor{blue}{
 This is the only part left of the paper that I want to confirm. I think $E$ needs to be the bounded space of continuous functions. This is how it is defined in \cite{da-prato.g-atarek.ea:92:invariant} and \cite{assing.manthey:03:invariant}. How do we define the laws for random initial conditions, $\varphi$, that are almost surely in $L^2_{\rho}(\R^d)$? See \eqref{E:RandInit}. I believe there may not be an issue because of the $\varphi \in \mathcal{F}_0$ assumption but I want to make sure. It seems that other authors ignore this issue.
}
