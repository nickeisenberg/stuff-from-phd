...
to the \textit{parabolic Anderson model} \cite{carmona.molchanov:94:parabolic}.
 ...
 The aim of this paper is to investigate the conditions required to guarantee the existence of invariant measures for the solution to \eqref{E:SHE}, which is a crucial step towards the study of the ergodicity of the system. By an invariant measure for \eqref{E:SHE}, we mean a measure, $\eta$, on some Hilbert space $(E, \mathscr{B}(E))$ such that
 \[
 \eta(A) = \int_{E} \mathscr{L}(u(t,\cdot, \zeta))(A) \; \eta(\ud \zeta), \quad \forall t \ge 0,
 \]
 where $A \in \mathscr{B}(E)$ and $\mathscr{L}(u(t,\cdot,\zeta))(A)$ is the law of \eqref{E:SHE} starting from $\zeta$. DaPrato and Zabczyk \cite{da-prato.g-atarek.ea:92:invariant} established the following procedure:
 \begin{enumerate}
