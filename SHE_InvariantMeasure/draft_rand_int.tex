...
\begin{example} \label{Ex:Finv}
  One should note that the assumption that $\mathcal{F}^{-1}\left(\sqrt{\widehat{f}}\right)(x)$ is
  nonnegative, or equivalently that $\sqrt{\widehat{f}}$ is non-negative definite, is quite strong and
  may not be true even if $f$ is non-negative and non-negative definite. Indeed, suppose that $d=1$
  and $\widehat{f}(\xi) = 2^{-2}\max\{2-|\xi|,0\}$. Then as explained in Example \ref{Ex:nonnegative},
  $f$ is non-negative and non-negative definite. We will now show that in this case,
  $\mathcal{F}^{-1}\left(\sqrt{\widehat{f}}\right)(x)$ takes on both positive and negative values.
  Indeed, for $x>0$, we see that
  \begin{align*}
    \mathcal{F}^{-1}\left(\sqrt{\widehat{f}}\right)(x)
    & = 2 \int_0^2 2^{-1}\sqrt{2-\xi} \cos(x \xi) \: \ud \xi
      = 2 \int_0^{\sqrt{2}} \xi^2 \cos(2x- x \xi^2) \: \ud \xi                                                                   \\
    & = 2\cos(2x) \int_0^{\sqrt{2}} \xi^2 \cos(x \xi^2) \: \ud \xi  +2 \sin(2x) \int_0^{\sqrt{2}} \xi^2 \sin(x \xi^2) \: \ud \xi \\
    & = - \cos(2x) \int_0 ^{\sqrt{2}} \frac{\sin(x \xi^2 )}{x} \: \ud \xi + \sin(2x) \int_0 ^{\sqrt{2}} \frac{\cos(x \xi^2)}{x} \: \ud \xi,
  \end{align*}
  where we have applied the change of variables $\xi' = \sqrt{2 - \xi}$ in the second equality and in
  the fourth inequality we have applied the integration by parts.
  Then by the change of variables $\xi' = \sqrt{2x/\pi} \: \xi$, we can conclude that
  \begin{align*}
      \mathcal{F}^{-1}\left(\sqrt{\widehat{f}}\right)(x) =\sqrt{\frac{\pi}{2}} |x|^{-3/2} \left(-\cos(2|x|)\mathcal{S}\left(\frac{2\sqrt{|x|}}{\sqrt{\pi}}\right) + \sin(2|x|) \mathcal{C}\left( \frac{2 \sqrt{|x|}}{\sqrt{\pi}} \right) \right), \quad \text{for all } x \in \R,
  \end{align*}
  where $\mathcal{S}$ and $\mathcal{C}$ are the Fresnel integrals (see \cite[7.2
  (iii)]{olver.lozier.ea:10:nist}):
  \begin{align*}
  ...
  \end{align*}
  Thus even if $f$ is both non-negative and non-negative definite, we may still have problems with
  removing the absolute value sign (see Figure \ref{Fig:fresnel}).
\end{example}
...
\begin{figure}[htbp]
  ...
  \begin{center}
    \begin{tikzpicture}[scale=0.8, transform shape]
      \begin{axis}[ xtick={-8,-4,0,4,8} ]
        \addplot[smooth, thick] coordinates {
          ( -8.001,0.023983353034662976 )
          ( -7.901,0.03108968557257685 )
          ( -7.800999999999999,0.03743403083076435 )
          ( -7.701,0.04273702428795622 )
          ( -7.600999999999999,0.04675003151361122 )
          ( -7.5009999999999994,0.049266102783459 )
          ( -7.401,0.05012973229618755 )
          ( -7.300999999999999,0.04924500599912395 )
          ( -7.201,0.0465817680192077 )
          ( -7.100999999999999,0.04217949693998189 )
          ( -7.0009999999999994,0.03614865790172984 )
          ( -6.901,0.0286693824266277 )
          ( -6.800999999999999,0.0199874221502741 )
          ( -6.701,0.010407422152845139 )
          ( -6.600999999999999,0.00028366081505671486 )
          ( -6.5009999999999994,-0.009991497499364317 )
          ( -6.401,-0.020001096797098213 )
          ( -6.300999999999999,-0.02931860596305691 )
          ( -6.201,-0.03752396023078127 )
          ( -6.100999999999999,-0.04422007354541917 )
          ( -6.0009999999999994,-0.04904922882751864 )
          ( -5.901,-0.05170873414591283 )
          ( 1.4990000000000006,0.5358330758061921 )
          ( 1.599000000000002,0.4235912509374337 )
          ( 1.6990000000000016,0.31905453355755 )
          ( 1.7990000000000013,0.2235038849135136 )
          ( 1.899000000000001,0.13796632677070164 )
          ( 1.9990000000000006,0.06320028667853343 )
          ( 2.099000000000002,-0.0003117448699712772 )
          ( 2.1990000000000016,-0.05236322608551829 )
          ( 2.2990000000000013,-0.09301643299298828 )
          ( 2.399000000000001,-0.12258857343283898 )
          ( 2.4990000000000006,-0.1416317171134419 )
          ( 2.599000000000002,-0.15090727625406236 )
          ( 2.6990000000000016,-0.15135590977635688 )
          ( 2.7990000000000013,-0.14406383369000839 )
          ( 2.899000000000001,-0.13022659845525478 )
          ( 2.9990000000000006,-0.11111143889635261 )
          ( 3.099000000000002,-0.08801931295803894 )
          ( 3.1990000000000016,-0.062247722589634485 )
          ( 3.2990000000000013,-0.03505535470494656 )
          ( 3.399000000000001,-0.00762949488462308 )
          ( 3.4990000000000006,0.018942945458471413 )
          ( 3.599000000000002,0.04370008228365633 )
          ( 3.6990000000000016,0.06582483879858586 )
          ( 3.7990000000000013,0.08465946352964457 )
          ( 3.899000000000001,0.09971457061765478 )
          ( 3.9990000000000006,0.11067266058580973 )
          ( 4.099000000000002,0.11738625023284703 )
          ( 4.199000000000002,0.11987090162628797 )
          ( 4.299000000000001,0.11829358753937697 )
          ( 4.399000000000001,0.11295695978161564 )
          ( 4.4990000000000006,0.10428019409172984 )
          ( 4.599000000000002,0.09277716776048255 )
          ( 4.699000000000002,0.07903278196149316 )
          ( 4.799000000000001,0.06367826883803207 )
          ( 4.899000000000001,0.047366323595448796 )
          ( 4.9990000000000006,0.030746874969945406 )
          ( 5.099000000000002,0.014444255135821819 )
          ( 5.199000000000002,-0.0009635451785770501 )
          ( 5.299000000000001,-0.014962945735050465 )
          ( 5.399000000000001,-0.02711969062930553 )
          ( 5.4990000000000006,-0.03709025083094885 )
          ( 5.599000000000002,-0.044629490117977726 )
          ( 5.699000000000002,-0.049594502882638 )
          ( 5.799000000000001,-0.051944664490394823 )
          ( 5.899000000000001,-0.0517380611326801 )
          ( 5.9990000000000006,-0.04912458237233347 )
          ( 6.099000000000002,-0.0443360622320227 )
          ( 6.199000000000002,-0.03767394066761247 )
          ( 6.299000000000001,-0.029494984205354804 )
          ( 6.399000000000001,-0.020195650714152875 )
          ( 6.4990000000000006,-0.010195707798055759 )
          ( 6.599000000000002,0.00007828303322301262 )
          ( 6.699000000000002,0.01020902284354422 )
          ( 6.799000000000001,0.019803517366635683 )
          ( 6.899000000000001,0.02850660622987001 )
          ( 6.9990000000000006,0.036012552845684116 )
          ( 7.099000000000002,0.04207435303701088 )
          ( 7.199000000000002,0.04651051415253076 )
          ( 7.299000000000001,0.04920915572622382 )
          ( 7.399000000000001,0.05012938397431448 )
          ( 7.4990000000000006,0.049299991989560255 )
          ( 7.599000000000002,0.04681563192375429 )
          ( 7.699000000000002,0.04283069156644495 )
          ( 7.799000000000001,0.03755118269380033 )
          ( 7.899000000000001,0.031225010136725385 )
          ( 7.9990000000000006,0.024131036771904032 )
        };
    \end{axis}
    \end{tikzpicture}
  \end{center}
  ...
  \caption{A plot of $\mathcal{F}^{-1}\left(\sqrt{\widehat{f}}\right)(x)$ for $\widehat{f}(\xi) =
  2^{-2}\max\{2-|\xi|,0\}$ with $-8 \le x \le 8$.}
  \label{Fig:fresnel}
\end{figure}
