...
\begin{lemma} \label{L:yineq}
  Fix an arbitrary $ t_0>0$. Let $v(t,x)$ be the solution to the restarted SHE \eqref{E:restart} and
  $\dot{W}_{t_0}$ be the time-shifted noise; see \eqref{E:ShiftW}. For any $\alpha\in (0,1/2)$,
