...
found in \cite{CH16Comparison,CK15SHE}.
...
\begin{proof}
	...
	\textcolor{magenta}{Where is your $\varphi$ in the above proof?}
...
\textcolor{magenta}{Inconsistency in typeseting, such as $\E$ not $E$,  and $\ud s$ not  $ds$.}
