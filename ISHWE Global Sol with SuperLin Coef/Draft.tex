...
Suppose that $\beta \in (0,1]$ and that $0 \le s < t$. Then,
	\begin{align}
...
This can no longer be written as a Mittag-Leffler function since by \cite[(A.19)]{CHHH16} we would have 
	...
	\]
and $E_{\alpha, \beta}$ is not defined for $\beta = 0$. So I am unsure of how to calculate \eqref{E:DZnorm} in this case. 
	\end{NickQuestion}
