...
\[
	Y_{r,t} = \exp\left( \int_r^t \sigma'(X_s) \ud B_s + \int_r^t b'(X_s) - \frac{1}{2}(\sigma')^2(X_s) \ud s \right)
\]
that $\exp(Y_{r,t})$ solve \eqref{deq}. By Itos formula we have that 
\begin{align*}
	\exp(Y_{r,t}) & = \exp(Y_{r,r})  +  \int_r^t \sigma'(X_s)Y_{r,s} \ud B_s + \int_0^t Y_{r,s} \left(\frac{1}{2}(\sigma')^2(X_s)+b'(X_s) -\frac{1}{2}(\sigma')^2(X_s)\right) \ud s
	\\& = \exp(Y_{r,r})  +  \int_r^t \sigma'(X_s)Y_{r,s} \ud B_s + \int_0^t Y_{r,s} b'(X_s)\ud s
\end{align*}
