...
\begin{align*}
	...
	\\& = \lim_{\epsilon \to 0} \dfrac{f(W(h_1),...,W(h_i)+\epsilon \langle h_i ,h \rangle, ,...,W(h_n))-F}{\epsilon } 
\end{align*}
...
\]
when $F_n \in \mathcal S$. First I believe that this is a type and it needs to say 
\[
	\dfrac{1}{\epsilon}(F_n\circ \tau_{\epsilon g}-F_n)=\int_0^\epsilon \langle DF_n \circ \tau_{\alpha g}, \dot{g} \rangle_H \ud \alpha
\]
because above I showed that for $F=\int_0^Th(s) \ud B_s$ that we have 
\[
		\dfrac{1}{\epsilon}(F_n\circ \tau_{\epsilon g}-F_n)= \langle h, \dot{g} \rangle_H = \int_0^\epsilon \langle DF_n \circ \tau_{\alpha g}, \dot{g} \rangle_H \ud \alpha
\]
However I do not know how to show this for arbitrary $F \in \mathcal S$. 
