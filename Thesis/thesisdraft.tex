...
Because of its importance, we will finish this introduction with a brief discussion about the stochastic heat equation before giving a more thorough treatment in Section \ref{S:SHE}. As for the well-possedness of Equation \eqref{E:introSHE} above, Chen and Dalang \cite{chen.dalang:15:moments} proved the following:
