...
We will use a $0$-mean Gaussian noise, which we denote as $\dot{W}$, to introduce randomness into our system. The noise will always be uniquely defined by associating it with an appropriate positive-definite covariance functional of the following form:
