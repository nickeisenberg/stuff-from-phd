...
with
	...
	\]
By setting $\alpha_0=0$ and letting $g(s,x)=g(x) \in \mathcal{F}_a$ be independent in $s$, which is the time-independent setup, then Equation \eqref{E:AsymStable-t} and Lemma \ref{L:EvsM} together recover the above theorem.
\textcolor{magenta}{Please give the explicit relation between $\mathcal{M}_{a,d}(\gamma)$ and $\mathbf{M}(a,0,d,\gamma)$.}
