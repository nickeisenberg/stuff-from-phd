...
\author{Le Chen\footnote{Email: \url{lzc0090@auburn.edu}}~
	and
	Nick Eisenberg\footnote{Corresponding author. Email:
\url{...@auburn.edu}}}
\date{\today}
...
moment asymptotics; time-independent Gaussian noise.
...
\begin{example}[Asymptotics for SHE]
	...
	conjectured results for SHE, namely, (1.16) and (1.17) of \cite{BCC21}, respectively, which are
	equivalent to Theorem 1.1 and 1.2 of \cite{Chen17AIHP} when setting $\alpha_0=0$ and using
	\cite[Lemma A.2]{ChenHuSongXing15AIHP} to rewrite the constant $\mathcal{E}$ in \cite{Chen17AIHP}
	in terms of $\mathcal{M}_a$. Due to the importance of the white noise case, we list the
	corresponding asymptotics here. When $\alpha=d=1$,
	\begin{align}
		\label{E:AsymSHE1d}
