...
\subsection{Variational constants}
\label{SS:Variation}
...
\begin{proof}[Sketch of the proof of Theorem \ref{T:Variation}]
	...
	will only point out the differences and necessary changes. The theorem is proved by showing the
	following claims: for $\gamma$ given in Assumption  \ref{A:Noise},
	\begin{enumerate}[(i)]
		\item $\rho_{\nu,a}(\gamma)<\infty$;
