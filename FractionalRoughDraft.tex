...
In this section, we list some concrete examples regarding the solvability --- Theorem
\ref{T:solvable}.
...
results for both stochastic wave and heat equations. We will need the following relation:
\begin{align}
	\label{E:Mdelta1d}
