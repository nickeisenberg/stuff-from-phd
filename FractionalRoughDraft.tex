...
\begin{proof}
	...
	{\bigskip\noindent\it (ii)~} Here we will prove part (2) of Theorem \ref{T:solvable}. The critical
	case happens when the exponent of $n!$ in \eqref{E:pmomBd} vanishes, namely,
	\begin{align*}
	...
	We start by proving \eqref{E:pnormconverge}. By the hyperactivity property (see \cite[Lemma
	B.1]{BCC21}), we have that
	\begin{align*}
