...
\end{align*}
see Section \ref{SS:LD} for more notation and details.
...
The second main result of the paper is about the moment asymptotics.
...
\begin{lemma}
	\label{L:rhofinite}
	For any $f,g,h$ with $h\ge0$ and for $\varphi$ given as in \eqref{E:specfunction}, we have the following:
	\begin{align*}
