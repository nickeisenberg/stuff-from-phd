...
\begin{proof}
	...
	\end{align*}
	Hence, By the Cauchy-Hadamard theorem, the radius of convergence for this series
	\eqref{E:SerieCr-2} is equal to $R:= (2\rho)^{-1}$, namely,  the series in \eqref{E:SerieCr-2}
	diverges (resp. converges) when $\theta t< R$ (resp. $\theta t < R$).  Therefore, the critical
	time $T_2 = R/\theta = (2\rho\theta)^{-1}$. This completes the proof of part (ii) of Lemma
	\ref{L:2ineq}.
\end{proof}
