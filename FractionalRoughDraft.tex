...
\end{align*}
We direct the reader to \cite[Section 5]{BS2017} for a complete treatment of this processes. For
ease of notation, throughout this article, we may write the above integrals as
\begin{align*}
...
\begin{theorem}% {{{
  \label{T:Variation} For the correlation function $\gamma$, with $\alpha < \min\{2a,d\}$, that also
  satisfies Assumption \ref{A:Noise}, both \eqref{E:rhoLam} and \eqref{E:LogRhoRiez} hold with
