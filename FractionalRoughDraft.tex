...
\begin{figure}[htb]% {{{ F:SWE
	...
	\caption{Solvability for the stochastic wave equation (i.e., $a=b=2$ and $r=0$) with $p\ge 2$. See
	Figure \ref{F:SHE} for more legends.}
	\label{F:SWE}
\end{figure}% }}}
