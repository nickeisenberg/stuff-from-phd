...
\begin{figure}[htpb]
	...
	\end{tikzpicture}
	\caption{Illustration of the sufficient conditions (Assumption \ref{A:Nonnegative}) for
...
\begin{theorem}
	\label{T:solvable}
	Under Assumption \ref{A:Nonnegative}, equation \eqref{E:SPDE} driven by the noise with spectral
