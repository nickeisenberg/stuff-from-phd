...
and exclusively for the fractional noise.  The corresponding moment asymptotics have been obtained
...
Before the end of this Introduction, let us make a few remarks and give some examples regarding our
assumptions \ref{A:Nonnegative} and \ref{A:Noise}.
...
\begin{example}[SWE]% {{{
	...
	\end{align*}
	which says that at dimension $d=3$, when the noise $\W$ is white noise, there exits only a local
	...
	\begin{enumerate}
		...
		\begin{align}
			\label{E:AsymSWE-2d}
				...
				\quad \text{and} \quad
				\lim_{p \to \infty} \frac{\log \E\left[|u(t,x)|^p\right]}{p^2} & = \frac{t^2\theta\mathcal{M}_2(\delta_0)}{2\nu}.
		\end{align}
	\end{enumerate}
\end{example}% }}}
