...
\cite{BCR09}, one needs to prove the corresponding inequality --- (1.27) on p. 630 ({\it ibid.}),
which was a consequence of Sobolev's inequality. For the more general noise studied in this paper,
we can no longer apply this inequality. Instead, we prove the following lemma using the weak Young's
inequality.
