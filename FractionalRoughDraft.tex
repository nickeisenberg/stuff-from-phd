...
\begin{proof}[Proof of Theorem \ref{T:solvable}]
	...
	{\bigskip\bf\noindent Step 5.~} Part (2) of Theorem \ref{T:solvable} will be proved in Lemma \ref{L:2ineq} below.
\end{proof}
...
\begin{lemma}
	...
	\end{align}
	(ii) Under condition \eqref{E:critical}, let $T_p$ be defined as in \eqref{E:Tp}. For all
	$x\in\R^d$, $p \ge 2$ and $\theta>0$, it holds that
...
\begin{proof}
	...
	{\bigskip\noindent\it (ii)~} Here we will prove part (2) of Theorem
	...
	We start by proving \eqref{E:pnormconverge}. By the hyperactivity property we have that 
	\[
	...
	To show \eqref{E:2normcutoff}, we use the Cauchy-Hadamard theorem and the same techniques above to see that the radius of convergence of the series
		...
		\]
	is precisely $T_2$. This completes the proof of the lemma.
\end{proof}
