...
\begin{remark}
	...
	we have the following four groups of sufficient conditions, under either group of which
	$G(t,\cdot)$ is nonnegative (see Figure \ref{F:Nonnegative} for an illustration):
	\begin{enumerate}
...
In this section, we will give various examples to our main results. When $a=2$ and $d=1$ we have the following useful relation:
\begin{align}
	\label{E:Mdelta1d}
	\mathcal{M}_2(\delta_0)= (3/4)(1/6)^{1/3} ,
\end{align}
...
\begin{example}[SHE with fractional Laplace]% {{{
	...
	\begin{align}
		...
		T_p = \frac{\nu}{2\theta (p-1)\mathcal{M}_a(\delta_0)}, \qquad \text{for $p\ge 2$}.
	\end{align}
\end{example}% }}}
