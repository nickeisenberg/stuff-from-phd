...
\begin{proof}
	...
	{\bigskip\noindent\it (ii)~} By applying $\alpha = \frac{a}{b}\left[ 2(b+r) - 1 \right]$ to \eqref{E:2nomBd}, we see that 
	
	\begin{align*}
		\sum_{n \ge 0} \theta^n n! \Norm{\tilde{f}_n(\cdot,0;t)}_{ \mathcal{H}^{\otimes n }}^2 &= \sum_{n \ge 0} \theta^n n! t^{ [2(b+r) - b\alpha /a]n } \Norm{\tilde{f}_n(\cdot,0;1)}_{ \mathcal{H}^{\otimes n }}^2
		\\& \le C \sum_{n \ge 0} \theta^n  t^{ [2(b+r) - b\alpha /a]n } \frac{ \left( 2^{[2(b+r)-\frac{b \alpha}{a}]} C_\mu(\nu,a) \right)^n }{ (n!)^{2(b+r)-1-b\alpha /a} }
		\\& = C \sum_{n \ge 0}   \left(2 \theta t C_\mu(\nu,a) \right)^n 
	\end{align*}
...
which is equivalent to 
	\begin{align*}
		t < \frac{1}{2 \theta C_\mu(\nu,a)} = T_2 \quad \text{for } \alpha = \frac{a}{b}\left[ 2(b+r) - 1 \right].
	\end{align*}
\end{proof}
