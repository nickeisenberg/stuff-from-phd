...
{Nicholas Eisenberg\\
\bigskip
\small Joint work with L. Chen (arXiv:2108.11473)
}
...
\end{frame}% }}}
	...
	\]
where $G$ is defined through the {\it Fox-H} function.
\\ $\;$ \\
...
Using this scaling property we see that
	...
	\begin{lemma}[{\small Lemma 4.1 R.  Balan, L. Chen \& X. Chen '21}]
		\begin{align*}
...
\end{frame}% }}}
	...
	\begin{frame}[t]% {{{ Moment asymptotics
		\frametitle{The Moment Asymptotics}
		\begin{theorem}[{\small Chen-E. '21+}]
...
\end{frame}% }}}
	...
	\frametitle{Exact Moment Lyapunov Exponent: \small (Recall $\beta := \frac{2(b+r)-\frac{b\alpha}{a}}{ 2(b+r)-\frac{b\alpha}{a} -1}$)}
