...
\rdot This implies that the $\eta$-average of $x \mapsto P_t(x,\Gamma)$ is $\eta(\Gamma)$ and this is independent of time:
\[
...
\begin{frame}{Weight examples}
	...
	\rdot Numerically it is suggested that for any $1<b<2$ and $a > 0$ that 
		...
		\]
	is not admissible, but this has not been proven. 
	\end{minipage}
	\begin{minipage}{3in}
		\centering
		\begin{figure}
