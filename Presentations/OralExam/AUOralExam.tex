...
\end{frame}
	...
	\begin{frame}[t]
		...
		\end{align*}
		The above lemma says that $\frac{1}{n}\log{R_n} \to \log(2 \rho)$. Now the Cauchy-Hadamard theorem can be directly applied to see that the radius of convergence is precisely $(2\theta \rho)^{-1} = T_2$.
